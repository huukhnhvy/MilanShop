...
<div class="page-wrapper">
    ...
    <div class="page-breadcrumb">
        <div class="row">
            ...
            <div class="col-md-4 col-md-offset-3" style="margin-left: auto;">
                <form action="${pageContext.request.contextPath}/admin-manager" method="post" class="search-form">
    ...
    <div class="container-fluid">
        <!-- Start Page Content -->
        <div class="row">
            <form action="<c:url value="/admin-manager"/>" id="formSubmit" method="get">
            <div class="col-12">
                <div class="card">
                        ...
                        <c:forEach var="item" items="${listUser}">
                            <tr>
                                ...
                                <td><ul style="list-style-type: none; padding-left: 0;">
                                    <c:url var="edit" value="/admin-edit">
                                    ...
                                    <c:url var="delete" value="/admin-manager">
            ...
            <div id="addEmployeeModal" class="modal fade">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <form action="${pageContext.request.contextPath}/admin-manager" method="post">
                                    ...
                                    <c:forEach var="item" items="${role}">
                                        <div class="form-check form-check-inline">
                                            <input type="radio" class="form-check-input"
                                                   name="pkId" value="${item.id}"   required/>
